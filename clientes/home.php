...
<body>
    ...
    <div id="backSlider">
        <h2 id="destacados" style="color:white">Productos recientes</h2>
        <div class="slider">
            <ul>
                <li>
                    <a href="ver_producto.php?id=42&t=0"><img src="../productos/slider/troll.png" alt="">
                </li>
                <li>
                    <a href="ver_producto.php?id=43&t=0"><img src="../productos/slider/arte.png" alt="">
                </li>
                <li>
                    <a href="ver_producto.php?id=44&t=0"> <img src="../productos/slider/padre.png" alt="">
                </li>
                <li>
                    <a href="ver_producto.php?id=45&t=0"> <img src="../productos/slider/guerra.png" alt="">
                </li>
            </ul>
        </div>
    </div>
